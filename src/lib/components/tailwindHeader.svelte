...
<nav class="bg-gray-100 text-black">
	<div class="max-w-6xl mx-auto px-4">
		<div class="flex justify-between">
			<div class="flex space-x-4 items-center">
				...
				<div>
					<a href="/" class="flex items-center py-3 px-2 text-gray-700 hover:text-gray-900"
						><svg
							class="text-blue-400 h-6 w-6 mr-1"
			...
			<div class="hidden md:flex items-center space-x-1">
				...
				<a
					href="/"
					class="py-2 px-3 bg-yellow-400 hover:bg-yellow-300 text-yellow-900 hover:text-yellow-800 rounded "
					>Signup</a
				>
			</div>
...
<div class="py-32 text-center">
	<h2 class="font-extrabold text-6xl">navbars in talwind</h2>
</div>
